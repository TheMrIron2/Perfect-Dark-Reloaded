...
cvar_t	gl_cshiftpercent = {"gl_cshiftpercent", "70", false};

cvar_t  gui_alpha = {"gui_alpha", "0.5", true};
...
void V_CalcBlend (void)
{
	...
	{
		if (!gl_cshiftpercent.value || !r_polyblend.value)
			continue;
...
void V_Init (void)
{
    ...
    Cvar_RegisterVariable (&gui_alpha);
