...
void Sbar_DrawPic (int x, int y, qpic_t *pic)
{
    if (cl.gametype == GAME_DEATHMATCH)
		Draw_AlphaPic (x , y + (vid.height-SBAR_HEIGHT), pic, gui_alpha.value);
	else
		Draw_AlphaPic (x + ((vid.width - 320)>>1), y + (vid.height-SBAR_HEIGHT), pic, gui_alpha.value);
}
...
void Sbar_SoloScoreboard (void)
{
	...
	sprintf (str,"&cF00Monsters:%3i /%3i", cl.stats[STAT_MONSTERS], cl.stats[STAT_TOTALMONSTERS]);
	Sbar_DrawColoredString (8, 4, str, 0);

	//sprintf (str,"Secrets :%3i /%3i", cl.stats[STAT_SECRETS], cl.stats[STAT_TOTALSECRETS]);
	//Sbar_DrawString (8, 12, str);

	sprintf (str,"&c0F0Secrets :%3i /%3i", cl.stats[STAT_SECRETS], cl.stats[STAT_TOTALSECRETS]);
	Sbar_DrawColoredString (8, 12, str, 0);
...
// time
	...
	sprintf (str,"&c00FTime :%3i:%i%i", minutes, tens, units);
	Sbar_DrawColoredString (184, 4, str, 0);

// draw level name
	l = strlen (cl.levelname);
	//Sbar_DrawString (232 - l*4, 12, cl.levelname);
    sprintf (str,"&c0FF %s", cl.levelname);
    Sbar_DrawColoredString (232 - l*4, 12, str, 0);
}
...
void Sbar_Draw (void)
{
	...
	sprintf (str, "&cF00%3i/%3i", cl.stats[STAT_MAG], cl.stats[STAT_AMMO]);
	Sbar_DrawColoredString(0, 0, str, 0);
